...
namespace NetSatis.Entities.Mapping
{
    public class DepoMap : EntityTypeConfiguration<Depo>
    {
        public DepoMap()
        {
            ...
            this.Property(p => p.DepoAdi).HasMaxLength(15);
            this.Property(p => p.YetkiliKodu).HasMaxLength(15);
            this.Property(p => p.YetkiliAdi).HasMaxLength(15);
            this.Property(p => p.Il).HasMaxLength(15);
            this.Property(p => p.Ilce).HasMaxLength(15);
            this.Property(p => p.Semt).HasMaxLength(15);
            this.Property(p => p.Adres).HasMaxLength(15);
            this.Property(p => p.Telefon).HasMaxLength(15);
